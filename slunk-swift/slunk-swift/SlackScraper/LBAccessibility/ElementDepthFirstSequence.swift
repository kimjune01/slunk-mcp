        ...
        public mutating func next() async -> StackItem? {
            while !stack.isEmpty {
                ...
                if stack.count > ElementDepthFirstSequence.maxStackSize {
                    print("ElementDepthFirstIterator: Stack size exceeded maximum (\(ElementDepthFirstSequence.maxStackSize))")
                    stack = []
                    return nil
                }
                ...
                if incrementThreshold > lastLoggedSize / ElementDepthFirstSequence.stackSizeLogIncrement {
                    print("ElementDepthFirstIterator: Stack size: \(incrementThreshold * ElementDepthFirstSequence.stackSizeLogIncrement)")
